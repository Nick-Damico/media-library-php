...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
  ...
  // Hidden Field to Protect against bots filling out form (Spam)
    ...
    <?php
      if (isset($_GET["status"]) && $_GET["status"] == 'thanks') {
          ...
          if (isset($error_message)) {
            ...
            echo '<p>Something you would like to add? Let me know by completing the form below.</p>';
          } ?>
        ...
        <form method="post" action="suggest.php">
            ...
            <tr>
                ...
                <td>
                  <textarea id="details" name="details">
                    <?php if (isset($details)) { echo htmlspecialchars($details); } ?>
                  </textarea>
                </td>
            </tr>
            <tr>
              ...
              <td>
                  <select name="format" id="format">
                      ...
                      <optgroup label="Games">
                        ...
                        <?php if (isset($format) && $format == 'Digital Download') {
                          echo " selected";
                        }
                        ?>>Digital Download</option>
                        <option value="Mobile"
                        <?php if (isset($format) && $format == 'Mobile') {
                          echo " selected";
                        }
                        ?>>Mobile</option>
                        <option value="Nintendo"
                        <?php if (isset($format) && $format == 'Nintendo') {
                          echo " selected";
                        }
                        ?>>Nintendo</option>
                        <option value="Playstation"
                        <?php if (isset($format) && $format == 'Playstation') {
                          echo " selected";
                        }
                        ?>>Playstation</option>
                        <option value="PC"
                        <?php if (isset($format) && $format == 'PC') {
                          echo " selected";
                        }
                        ?>>PC</option>
                        <option value="Xbox"
                        <?php if (isset($format) && $format == 'Xbox') {
                          echo " selected";
                        }
                        ?>>Xbox</option>
                      </optgroup>
          ...
          <tr>
            ...
            <tr>
                ...
                <td>
                  <input
                    id="year" type="text" name="year" placeholder="ex. 2001"
            ...
            <tr style="display: none;">
                ...
                <!-- Please leave this input blank on submission. -->
            </tr>
          </table>
